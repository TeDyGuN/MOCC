...
<h2 align="center">Reporte de Docentes</h2>
<div class="table table-striped" align="center">
    <table border=1 cellspacing=0 align="center">
        <tr>
            <th class="success" width="20%">Nombres.</th>
            <th class="success" width="20%">Apellidos</th>
            <th class="success" width="20%">Celular</th>
        ...
        <tr align="center">
            ...
            <td class=" text-center"> <?php echo ($d->apellidos); ?></td>
            <td class=" text-center"> <?php echo ($d->celular); ?></td>
